  ...
  describe("GET endpoint", function() {
    it("should return all existing posts", function() {
      ...
      return chai
        .request(app)
        .get("/posts")
        .then(function(_res) {//the answer has => do i need this?
          res = _res;
    ...
    it("should return blog post with the right fields", function() {
      ...
      .then(function(res) {
        ...
        res.body.blogPost.forEach(function(posts) {
      ...
      .then(function(post){//why don't I have all the same five as in line 95-99?
...
describe ("PUT endpoint", function(){
  it('should update fields you send over', function(){
    const updateData= {//why not  use fake data?
